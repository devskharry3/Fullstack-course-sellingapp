...
const Buy = () => {
  ...
  const user = JSON.parse(localStorage.getItem("user") || "null"); // Read user fresh
  ...
  const handlePurchase = async (event) => { 
    ...
    if(confirmError){
      ...
      setCardError(""); 
      //setSuccessMessage(`Your payment ID: ${paymentIntent.id}`);
      ...
      console.log("Payment info:", paymentInfo);
       await axios.post("http://localhost:4002/api/v1/order" , paymentInfo, {
        headers: {
